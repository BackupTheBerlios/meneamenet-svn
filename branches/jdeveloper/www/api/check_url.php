...
if ($res) {
	echo '<a href="/story.php?id='.$res->link_id.'" title="'.$res->link_votes.' '._('votos').': '.$url.'" target="_parent" onmouseover="changebutton(\'mnm_vote\',\'mnm_yesover\')" onmouseout="changebutton(\'mnm_vote\',\'mnm_vote_notover\')"><img style="border: 0" src="'.$mnm_vote.'" target="_parent" name="mnm_vote"/></a>';
} else {
	echo '<a href="/submit.php?url='.urlencode($url).'" title="'._('enviar esta historia').': '.$url.'" target="_parent" onmouseover="changebutton(\'mnm_add\',\'mnm_yesover\')" onmouseout="changebutton(\'mnm_add\',\'mnm_add_notover\')"><img style="border: 0" src="'.$mnm_add.'" name="mnm_add"/></a>';
}
echo '</body></html>';
?>
