...
function to_html(data) {
	...
	if (data.type == 'chat') {
		...
		html += '<a href="user.php?login='+data.who+'"><img src="http://www.gravatar.com/avatar.php?gravatar_id='+data.md5+'&rating=PG&size=20&default='+default_gravatar+'" width=20 height=20></a>';
