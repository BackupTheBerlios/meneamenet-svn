...
<p>Los votos de los usuarios registrados no cuentan igual que un anónimo. Un voto anónimo vale cuatro (4) puntos, mientras que el voto de los usuarios registrados depende del <em>karma</em> que tenga el usuario. El karma base de los usuarios es ocho (8). Al menos dos veces por día <a href="http://mnm.uib.es/gallir/posts/2005/12/14/544/">se recalcula el valor del karma</a> de cada usuario.
</p>
</li>
