...
function do_credits() {
	...
	echo '<a href="./faq-'.$dblang.'.php#we">'._('quiénes somos').'</a>';
	echo '<br />';
	echo '<a href="http://meneame.wikispaces.com/" title="wiki meneame">'._('wiki').'</a>' . "\n";
	echo '&nbsp;&nbsp;|&nbsp;&nbsp;'._('código: ').' <a href="./COPYING">'._('licencia').'</a>, <a href="./archives/meneame-src.tgz">'._('descargar').'</a>';
	...
	echo '<a href="http://validator.w3.org/check?uri=referer"><img src="img/common/valid-xhtml10.png" alt="Valid XHTML 1.0 Transitional" height="31" width="88" /></a>' . "\n";
	echo '&nbsp;&nbsp;' . "\n";
	echo '<a href="http://jigsaw.w3.org/css-validator/check/referer"><img style="border:0;width:88px;height:31px" src="img/common/vcss.png" alt="Valid CSS!" /></a>&nbsp;&nbsp;' . "\n";
	echo '<a href="http://feedvalidator.org/check.cgi?url=http://meneame.net/rss2.php"><img src="img/common/valid-rss.png" alt="[Valid RSS]" title="Validate my RSS feed" /></a>' . "\n";
	echo '</span>' . "\n";
	echo '</div>' . "\n";
